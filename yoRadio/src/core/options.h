...
#endif
#ifndef BATTERY_PIN
  #define BATTERY_PIN       255     //  one of 36,37,38,39,32,33,34,35 https://docs.espressif.com/projects/esp-idf/en/v4.1.1/api-reference/peripherals/adc.html#enumerations
#endif
#ifndef BATTERY_CONVERSION_FACTOR        //                                     to BATTERY_PIN
  #define BATTERY_CONVERSION_FACTOR 1.97 // calibration [+BATTERY]------[100k]---------[|]---------[100k]------>>[GND]
#endif
#ifndef BATTERY_READS
  #define BATTERY_READS 15          //num of avg samples (15)
#endif
#ifndef BATTERY_DELAY
  #define BATTERY_DELAY 5          // check delay in seconds (30)
#endif
/*
...
#endif
#ifndef COLOR_BATTERY_HIGH
  #define COLOR_BATTERY_HIGH      43,  201,  0
#endif
#ifndef COLOR_BATTERY_MID
  #define COLOR_BATTERY_MID       231, 211,  90
#endif
#ifndef COLOR_BATTERY_LOW
  #define COLOR_BATTERY_LOW       255, 25,   25
#endif
